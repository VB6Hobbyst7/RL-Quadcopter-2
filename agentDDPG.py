...
class AgentDDPG():
    ...
    def __init__(self, task):
        ...
        self.noise = OUNoise(self.action_size, self.mu, self.theta, self.sigmaStart, self.sigmaEnd, self.decayExponent)
        ...
        # Actor (Policy) Model
        self.actor_local = Actor(self.state_size, self.action_size, self.action_low, self.action_high, learningRate=self.learningRateActor, dropoutRate=self.dropoutActor)
        self.actor_target = Actor(self.state_size, self.action_size, self.action_low, self.action_high, learningRate=self.learningRateActor, dropoutRate=self.dropoutActor)

        # Critic (Value) Model
        self.critic_local = Critic(self.state_size, self.action_size, learningRate=self.learningRateCritic, dropoutRate=self.dropoutCritic, l2Lambda=1e-2)
        self.critic_target = Critic(self.state_size, self.action_size, learningRate=self.learningRateCritic, dropoutRate=self.dropoutCritic, l2Lambda=1e-2)
...
class AgentDDPG():
    ...
    def __init__(self, env, hyperparams):
        ...
        self.actor_local = Actor(self.state_size, self.action_size, self.action_low, self.action_high, hyperparams['actorArch'], hyperparams['actorAF'], hyperparams['actorBN'], hyperparams['actorLR'], hyperparams['actorDO'], hyperparams['actorDORate'])
        self.actor_target = Actor(self.state_size, self.action_size, self.action_low, self.action_high, hyperparams['actorArch'], hyperparams['actorAF'], hyperparams['actorBN'], hyperparams['actorLR'], hyperparams['actorDO'], hyperparams['actorDORate'])
        print(" Done.")
        #print(self.actor_target.model.summary())

        # Critic (Q-Value) Model
        print("   Creating critc...", end='')
        self.critic_local = Critic(self.state_size, self.action_size, hyperparams['criticArch'], hyperparams['criticAF'], hyperparams['criticBN'], hyperparams['criticLR'], hyperparams['criticDO'], hyperparams['criticDORate'])
        self.critic_target = Critic(self.state_size, self.action_size, hyperparams['criticArch'], hyperparams['criticAF'], hyperparams['criticBN'], hyperparams['criticLR'], hyperparams['criticDO'], hyperparams['criticDORate'])
        print(" Done.")
        ...
        self.noise = OUNoise(self.action_size, hyperparams['noiseMu'], hyperparams['noiseTheta'], hyperparams['noiseSigmaStart'], hyperparams['noiseSigmaStart']-hyperparams['noiseReduction'], hyperparams['noiseDecay'])
        print(" Done.")
